...
a persistence unit "testPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "test/pom.xml":
...
artifacts ("test-ejb.jar" and "test-web.war") are already built. You can build
